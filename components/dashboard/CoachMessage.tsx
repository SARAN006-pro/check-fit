...
const CoachMessage: React.FC = () => {
  return (
    <MotionDiv 
      ...
      className="bg-white dark:bg-zinc-900/80 border border-blue-500/10 p-6 rounded-[32px] flex gap-5 items-start relative overflow-hidden shadow-premium dark:shadow-none"
    >
      ...
      <div className="space-y-1">
        <div className="flex items-center gap-2">
          <span className="text-[10px] font-black text-blue-600 dark:text-blue-500 uppercase tracking-widest">Neural Link Active</span>
