  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 px-2">
        ...
        <h3 className="text-[10px] font-black text-zinc-400 dark:text-zinc-500 uppercase tracking-[0.3em]">Mastery Vault</h3>
      </div>
        ...
        {badges.map((badge) => (
          <MotionDiv
            ...
            className={`shrink-0 w-32 h-32 rounded-[32px] border flex flex-col items-center justify-center gap-2 relative group overflow-hidden ${
              badge.unlocked 
                ? 'bg-white dark:bg-zinc-900 border-zinc-100 dark:border-white/10 shadow-premium dark:shadow-xl' 
                : 'bg-zinc-100 dark:bg-white/5 border-zinc-200 dark:border-white/5 grayscale opacity-40'
            }`}
          >
            {badge.unlocked && (
            ...
            <p className="text-[9px] font-black text-zinc-500 dark:text-zinc-400 uppercase tracking-widest text-center px-4 leading-tight">
            ...
            {!badge.unlocked && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/5 dark:bg-black/20 backdrop-blur-[2px]">
                <Lock className="w-4 h-4 text-zinc-500 dark:text-white/40" />
              </div>
            )}
          </MotionDiv>
        ))}
